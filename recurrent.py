...
class LSTMCell(Layer):
    ...
    def call(self, inputs, states, training=None):
        ...
        if self.implementation == 2: #TG-modify
            if 0 < self.dropout < 1.:
                inputs_i = inputs * dp_mask[0]
                inputs_f = inputs * dp_mask[1]
                inputs_c = inputs * dp_mask[2]
            ...
            c = (1.0-K.tanh(f)) * K.tanh(c_tm1) + K.tanh(i) * self.activation((1.0-K.tanh(x_c)) + K.dot(h_tm1_c,self.recurrent_kernel_c))#modify TG-LSTM
